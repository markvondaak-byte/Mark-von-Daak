...
FACHWORTE = {
    ...
    # „Der Darm im Gleichgewicht" — Fachbegriffe rund um Verdauung und
    # Mikrobiom. Sie stehen in keiner Wortliste und sind trotzdem richtig.
    "mikrobiom", "mikrobioms", "mikrobiota", "mikroorganismen", "darmflora",
    "darmbarriere", "darmschleimhaut", "darmwand", "darmbakterien",
    "darmzotten", "zotten", "mikrovilli", "bürstensaum", "enterozyten",
    "becherzellen", "schleimschicht", "mukusschicht",
    "dünndarm", "dünndarms", "dickdarm", "dickdarms", "zwölffingerdarm",
    "leerdarm", "krummdarm", "blinddarm", "grimmdarm", "enddarm",
    "ileozäkalklappe", "peristaltik", "peristaltische", "segmentation",
    "motilität", "migrierender", "motorkomplex",
    "bauchspeicheldrüse", "gallenflüssigkeit", "gallensäuren", "pepsin",
    "amylase", "lipase", "laktase", "proteasen", "enzymatisch",
    "ballaststoff", "ballaststoffe", "ballaststoffen", "ballaststoffarm",
    "ballaststoffarme", "ballaststoffreich", "ballaststoffreiche",
    "ballaststoffreichen", "ballaststoffreicher", "ballaststoffgehalt",
    "ballaststoffmenge", "ballaststoffquellen", "ballaststoffzufuhr",
    "quellstoffe", "quellstoff", "flohsamenschalen", "flohsamen",
    "inulin", "pektin", "betaglucan", "betaglucane", "resistente",
    "oligofruktose", "fruktane", "galaktane", "polyole",
    "präbiotika", "präbiotisch", "präbiotische", "präbiotischen",
    "probiotika", "postbiotika", "synbiotika", "fermentation",
    "fermentiert", "fermentierte", "fermentierten", "fermentierter",
    "fermentiertes", "fermentieren", "milchsäurebakterien",
    "laktobazillen", "bifidobakterien", "akkermansia", "bacteroides",
    "firmicutes", "prevotella", "faecalibacterium", "stämme", "stammes",
    "butyrat", "propionat", "azetat", "kurzkettige", "fettsäuren",
    "sauerkraut", "kimchi", "kefir", "wasserkefir", "kombucha", "miso",
    "sauerteig", "salzlake", "lake", "fermentierglas", "gärgefäß",
    "bristol", "stuhlformen", "stuhlgang", "stuhlfrequenz", "stuhlprobe",
    "blähungen", "völlegefühl", "meteorismus", "obstipation",
    "vagusnerv", "nervensystem", "enterisches", "darmhirnachse",
    "serotonin", "neurotransmitter", "immunsystem", "immunzellen",
    "schleimhautimmunität", "antibiotikum", "antibiotika", "antibiotische",
    "protonenpumpenhemmer", "abführmittel", "nichtsteroidale",
    "fodmap", "fodmaps", "histamin", "histaminarm", "laktose",
    "laktosefrei", "laktoseintoleranz", "fruktose", "fruktosemalabsorption",
    "sorbit", "xylit", "süßstoffe", "emulgatoren", "carrageen",
    "polysorbat", "hochverarbeitet", "hochverarbeitete",
    "hochverarbeiteten", "hochverarbeiteter", "verarbeitungsgrad",
    "nova", "zonulin", "calprotectin", "atemtest", "atemtests",
    "haferflocken", "haferkleie", "hafer", "gerste", "hirse", "buchweizen",
    "quinoa", "amaranth", "bulgur", "couscous", "vollkorn", "vollkornbrot",
    "vollkornnudeln", "pumpernickel", "topinambur", "schwarzwurzel",
    "pastinake", "pastinaken", "chicorée", "artischocke", "artischocken",
    "hülsenfrüchte", "kichererbsen", "belugalinsen", "kidneybohnen",
    "edamame", "leinsamen", "chiasamen", "kürbiskerne", "sonnenblumenkerne",
    "walnüsse", "paranüsse", "mandeln", "haselnüsse", "cashewkerne",
    "olivenöl", "rapsöl", "walnussöl", "naturjoghurt", "buttermilch",
    "dickmilch", "porridge", "overnight", "oats", "bowl", "smoothie",
    "meal", "prep", "dge", "efsa", "who", "bzfe",
}
