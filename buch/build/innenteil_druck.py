...
BAENDE = [
    ...
    # Band 4 läuft in beiden Bindearten auf 6 x 9 Zoll und braucht deshalb —
    # anders als Band 3 — nur einen Innenteil.
    ("Band 4", "adhs/out/chaos-mit-system.pdf", 152.4, 228.6),
]
