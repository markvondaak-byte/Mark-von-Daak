...
COVER_HTML = ('<!DOCTYPE html><html><head><meta charset="utf-8"><style>'
  ...
  '<path d="M0 320 V150 Q160 90 360 130 Q520 90 800 130 V320 Z" fill="#8a6a86" opacity=".6"/>'
  '<path d="M0 320 V210 Q240 160 520 200 Q680 175 800 200 V320 Z" fill="#6a4d72"/></svg>'
  '<div class="inner">'
